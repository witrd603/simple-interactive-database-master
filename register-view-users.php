...
echo '<table><tr>
<td><b>Name</b></td><td><b>Date Registered</b></td></tr>';
...
while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC))
{
	...
	echo '</table>'; //Close the table so that is is ready for displaying.
	...
	} // End of if ($result) mysqli_close($dbcon); // Close the database connection.
	?>
